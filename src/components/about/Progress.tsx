...
const Progress = () => {
  return (
    ...
    >
      <motion.p className="flex w-full justify-center p-8 text-center font-bold text-white sm:text-4xl"
  ...
  transition={{ duration: 0.75 }}>
      ...
      <div className="mb-8 flex w-1/2 flex-col items-center justify-center md:flex-row">
        <div className="flex w-1/2 flex-col items-center justify-center p-2">
          <motion.div className="text-center text-6xl font-extrabold text-ula-yellow-primary"
          initial={{ opacity: 0, x: -60 }}
  whileInView={{opacity: 1, x: 0 }}
  transition={{ duration: 0.75 }}>
            <CountUp start={0} duration={2} end={1500} />+
          </motion.div>
          <motion.p className="text-nowrap p-2 text-center text-white"
          initial={{ opacity: 0, x: 60 }}
  whileInView={{opacity: 1, x: 0 }}
  transition={{ duration: 0.75 }}>
            students helped
